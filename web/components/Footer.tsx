...
const Footer = () => {
  return (
    <div className='bg-footer-bg h-80 mt-auto'>
      <div className='h-4/5 flex'>
        <div className='w-4/6'>
            <div className='text-3xl font-bold text-white ml-11 mt-16'>
                HakimHub
            </div>
        </div>
        <div className='flex w-2/5 mr-44 '>
            <div className='my-16 w-full flex justify-between text-white'>
                <div className=''>
                    <div className='text-lg font-bold  mb-2'>Get Connected</div>
                    <ul className='text-lg font-normal'>
                        <li className='flex gap-2 mb-2'>
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-2'>
                                <path d="M7.26117 4.05604L2.00578 0.222534L0.769531 1.12446L4.79129 4.05859L0.769531 6.98826L2.00578 7.89019L7.26117 4.05604Z" fill="white"/>
                            </svg>
                            For Physicians
                        </li>
                        <li className='flex gap-2  mb-2'>
                ...
                <div className=''>
                    <div className='text-lg font-bold  mb-2'>Actions</div>
                    <ul className='text-lg font-normal'>
                        <li className='flex gap-2  mb-2'>
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-2'>
                                <path d="M7.26117 4.05604L2.00578 0.222534L0.769531 1.12446L4.79129 4.05859L0.769531 6.98826L2.00578 7.89019L7.26117 4.05604Z" fill="white"/>
      ...
      <div className='h-1/5'>
        ...
        <div className='flex text-lg justify-between pt-4'>
            <div className='flex ml-11 justify-between gap-28'>
                <div className='text-white font-semibold'>Privacy Policy</div>
                <div className='text-white font-semibold'>Terms of Use</div>
            </div>
            <div className='flex mr-56 space-x-14'>
