...
namespace Application.Features.ProuductFeature.Handlers.Queries
{
    public class GetAllProuductHandler : IRequestHandler<GetAllProductsQuery, BaseResponse<List<ProductResponseDTO>>>
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;
        public GetAllProuductHandler(IUnitOfWork unitOfWork,IMapper mapper)
        {
