...
{
    public class GetAllBookingHandler : IRequestHandler<GetAllProductsQuery, BaseResponse<List<ProductResponseDTO>>>
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;
        public GetAllBookingHandler(IUnitOfWork unitOfWork,IMapper mapper)
        {
