...
namespace Domain.Errors
{
    public static partial class Errors
    {
        public static class User
        {
            ...
            public static Error UserNotDeleted => Error.Validation(code: "UserNotDeleted", description: "User not deleted");
            public static Error UserNotUpdated => Error.Validation(code: "UserNotUpdated", description: "User not updated");
            }
    }
}