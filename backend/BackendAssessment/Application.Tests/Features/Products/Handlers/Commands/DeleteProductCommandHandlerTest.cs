...
public class DeleteProductCommandHandlerTest
{
    ...
    {
        var validDeleteProductCommand = new DeleteProductCommand { ProductId = new Guid(), UserId = new Guid() };
    ...
    {
        var invalidDeleteProductCommand = new DeleteProductCommand { ProductId = new Guid(), UserId = new Guid() };
